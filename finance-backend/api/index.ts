    ...
    swagger({
      documentation: {
        info: {
          ...
          description: 'API para tesorería, cuentas por cobrar (AR) y cuentas por pagar (AP)',
          version: '1.0.0',
        },
        tags: [
          { name: 'api-keys', description: 'Gestión de API keys' },
          { name: 'treasury', description: 'Tesorería' },
          { name: 'ar', description: 'Cuentas por cobrar' },
          { name: 'ap', description: 'Cuentas por pagar' },
        ],
